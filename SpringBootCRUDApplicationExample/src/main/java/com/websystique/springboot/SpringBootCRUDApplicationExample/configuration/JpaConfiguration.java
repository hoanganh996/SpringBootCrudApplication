package com.websystique.springboot.SpringBootCRUDApplicationExample.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.websystique.springboot.SpringBootCRUDApplicationExample.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.websystique.springboot.SpringBootCRUDApplicationExample.model" });
